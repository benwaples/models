...
describe('Nut class', () => {
  ...
  it('should edit a nut by id', async() => {
    const peanut = await Nut.insert({
      name: 'peanut',
      size: 'small',
      isGood: true
    ...
    const editedPeanut = await Nut.edit(peanut.id, {
      name: 'Mega peanut',
      size: 'large',
      isGood: false
    });

    expect(editedPeanut).toEqual({
      id: peanut.id,
      name: 'Mega peanut',
      size: 'large',
      is_good: false
  ...
  it('should delete a nut by id', async() => {
    const peanut = await Nut.insert({
      name: 'peanut',
      size: 'small',
      isGood: true
    ...
    const deletedPeanut = await Nut.delete(peanut.id);

    expect(deletedPeanut).toEqual({
      id: peanut.id,
      name: 'peanut',
      size: 'small',
      isGood: true
